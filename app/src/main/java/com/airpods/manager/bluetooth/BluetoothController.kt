...
class BluetoothController @Inject constructor(
    ...
    /**
     * Returns the list of devices currently connected to the A2DP profile.
     * Uses BluetoothManager.getConnectedDevices() which returns per-device connection state,
     * unlike BluetoothAdapter.getProfileConnectionState() which is adapter-level only.
     */
